...
app.post('/api/logout', (req, res) => {
    if(req.cookies && req.cookies.token && req.cookies.session_token){
        res.clearCookie('session_token',{path:'/',domain:'nomad-api-dot-centered-oasis-418917.wn.r.appspot.com',httpOnly: true,sameSite : "none",secure : true});
    }
    res.end()
})
